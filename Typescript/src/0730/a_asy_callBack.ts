...
function fetchDataCb(callback: (errer: Error | null, data: any) => void) {
    // 비동기 작업 수행
...
//* ex) 네트워크에서 문서를 받아온 뒤, 해당 문서를 작성한 유저의 다른 글을 가져오는 가상 코드

// fetchDocument(url, function(err, document) {
//     if (err) {
//         console.log(err);
//     } else {
//         fetchAuthor(document, function(error, author) {
//             if(err) {
//                 console.log(err);
//             } else {
...
// asyncFun1()
// .then((result1) => {
//     return asyncFun2(result1);
// })
// .then((result2) => {
//     return asyncFun2(result2);
// })
// .then((result3) => {
//     ...
// })
