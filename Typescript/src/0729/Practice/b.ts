...
//? 평균 점수 계산하기
// 학생들의 점수 정보 배열을 입력 받아, 평균 점수를 계산하는 calculateAverage 함수를 만들어 보세요.
// reduce() 사용
...
//? 최고 점수 학생 찾기
// 학생들의 점수 정보 배열을 입력 받아, 가장 점수가 높은 삭생의 정보를 반환하는 findTopStudent 함수를 생성
// reduce() 사용, 삼항 연산자
...
//? 합격자 목록 만들기
// 학생들의 점수 정보 배열을 입력 받아, 특정 점수 이상인 학생들의 목록을 반환하는 getPassList함수 생성
// filter() 사용
