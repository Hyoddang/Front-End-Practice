...
membership.addMember(new Member('Lee', 90, false));
membership.addMember(new Member('Park', 80));
membership.addMember(new Member('Choi', 70, false));
membership.addMember(new Member('Kim', 85))

console.log(membership.findMember('Park'));
console.log(membership.findMember('Yoon'));
membership.removeMember('Lee');
