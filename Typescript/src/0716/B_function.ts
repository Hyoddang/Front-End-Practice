...

{
    ...
    console.log(greet('Hyoddang')); // Hello, Hyoddang
    console.log(greet("Yoon", "Hi")); // Hi, Yoon
...
function doubleBoolean(arr: boolean[]): boolean[] {
    // concat(): 여러 개의 문자열을 하나의 데이터로 만들어주는 역할
