...
class InformationEvent {
    ...
    addEventAboutMeModifyClick(): void {
        ...
        const aboutMeModifyButton =
        document.querySelector<HTMLElement>(".m-aboutme");

        if (aboutMeModifyButton) {
        aboutMeModifyButton.onclick = () => {
            // s-aboutme 요소를 변수에 저장
            const aboutMeSaveButton =
            document.querySelector<HTMLElement>(".s-aboutme");
            ...
            const infoInput =
                infoInputContainer.querySelector<HTMLInputElement>(".info-input");
            if (infoInput) {
        ...
        addEventAboutMeSaveClick(): void {
            const aboutMeSaveButton =
            document.querySelector<HTMLButtonElement>(".s-aboutme");
            if (aboutMeSaveButton) {
            aboutMeSaveButton.onclick = () => {
                const aboutMeModifyButton =
                document.querySelector<HTMLButtonElement>(".m-aboutme");
    ...
    loadInfoPhoto(): void {
        ...
        if (infoPhotoImg) {
            ...
            if(infoPhoto == null) {
                infoPhotoImg.src = 'Typescript\src\Todo\images\밤 남자.jpg';
            } else {
    ...
    showPreview(fileValue: File): void {
        ...
        if (result) {
            ...
            const photoImg =
            document.querySelector<HTMLImageElement>(".info-photo img");
