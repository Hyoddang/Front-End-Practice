...
// 타입스크립트는 변수 선언 시 변수의 타입 명시
let naming: string = 'Lee';
const age: number = 24;
let isMarried: boolean = false;

// naming = 24; // 'number' 형식은 

//! 타입스크립트 타입

//! 원시 타입
// string, number, boolean
// JS에서 typeof연산자 사용했을 때 각각의 해당 타입이 출력되는 타입
...
// 문자 열거형
// 열거형 멤버에 지정된 값은 우의미하고 읽기 좋은 값을 미리 지정
...
// const oneHundred2: bigint = 100n; tsconfig.json에서 es2016으로 설정되어 있어 오류발생
