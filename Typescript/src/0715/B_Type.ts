...
// 타입 별칭을 갖게 될 타입(형태에서 Type의 위치)의 자리에는 기본 타입을 포함한 모든 타입이 올 수 있다.
...
//! 타입 어노테이션 (type Annotation): 변수 이름 뒤에 배치되면서 클론(:)과 타입 이름을 기재하여 타입을 명시하는 것
let phone;
phone = 'Galaxy';
phone.toUpperCase();
