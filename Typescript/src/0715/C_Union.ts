...
//? 내로잉
// : 값에 허용된 타입이 하나 이상의 가능한 타입의 되지 않도록 좁히는 것

//! 유니언 타입
// '이거 혹은 저거'
// 가능한 값 또는 구성 요소 사이에 |(vertical bar 파이프 기호) 연산자를 사용해 유니언타입을 정의
...
// idol3.toUpperCase();
// idol3.toFixed();
idol3.toString(); // toSring() : number타입과 string타입 모두 사용 가능
...
let actor2 = Math.random() > 0.5 ? 'Seo' : 29;
