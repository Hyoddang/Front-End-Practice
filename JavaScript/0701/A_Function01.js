...
//! 함수 호출 시 인수 와 매개변수 (아규먼트 & 파라미터)

// 함수를 호출할 때는 ()안에 인수(arguments)를 넣어 줄 수 있다.
// 이 인수는 함수 내부로 전달, 함수 내부에서는 매개변수(parameterts)라는 이름으로 사용

// argument
// 함수를 호출할 때 전달하는 실체 값, 함수 호출 시 괄호안에 넣어 함수에 전달

// parameter
// 함수의 입력으로 사용되는 변수를 의미, 함수를 정의할 때 괄호안에 선언
...
//! 반환 값(return);
// 입력 받아 처리한 결과를 반환
// 함수 내에서 return 키워드를 사용해서 지정 가능
// 함수 내에서 return 키워드를 사용하면, 함수의 실행을 즉시 중단하고 return뒤에 오는 값을 반환
...
// return 키워드가 없는 함수는 undefiend를 변환
