...
// 객체의 특정 속성이 flase로 반환될 수 있는 값(0, false, 빈 문자열)이 아닌 때와 같은 전제가 있어야 사용할 수 있는 코드
if (object.name) {
    console.log('name 속성이 있습니다.')
} else {
    console.log('name 속성이 없습니다.')
...
object.author || console.log('name 속성이 있습니다.')
...
// 배열은 복사 하더라도 다른 이름일 뿐, 같은 배열로 취급
// : 얕은 복사(참조 복사)
...
const food5 = ['milk', 'bread'];
const food6 = ['snack', ...food5 , 'jelly'];
