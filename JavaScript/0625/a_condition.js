...
if (number > 0) {
    console.log('The number is positiove');
}
...
//! 3. else-if문
// else if 문은 if와 else 사이에 여러 개의 조건을 추가
// if문과 else문 사이에 위치, 여러개의 조건을 확인할 수 있게 해주는 제어 구조
...
// 그 결과가 true이면 표현식1을, false이면 표현식2를 실행 : (if) else문의 로직과 동일
...
// 첫 번째 조건을 보고 빠르게 판단 할 수 있도록 로직을 구성해야 한다.

((x === 10) && (y === 20))

// AND연산자 : 첫 번째 조건식에 false가 될 확률이 높은 조건을 사용하는 것이 좋다.

// OR연산자 : 첫 번째 조건식으 true가 될 확률이 높은 조건을 사용하는 것이 좋다.
