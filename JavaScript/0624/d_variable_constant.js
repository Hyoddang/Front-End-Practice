...
// 띄어쓰기 허용 X
// 기호는 언더스코어, 달러만 사용 가능
// lowerCamelCase : 소문자로 작성, 두 개 이상의 단어 결합시 두 번째 단어의 첫 시작을 대문자로 지정
...
// 이름을 의미있게 작성
// pw(x) password(o)
// 올해연도 : Year1(x) currentYear(o)
// 태어난 연도 : Year2 birthYear(o)
...
// 올해 연도를 나타내는 변수에는 2023(올해연도) 값 할당
...
// 상수는 한 번 할당된 값을 변경할 수 없다.
// 상수의 경우 선언을 할 때 무조건 초기화 시켜야 한다.
...
lowerCamelCase
// UPPER_SNAKE_CASE
// 모든 문자를 대문자로 작성, 두 개 이상의 단어가 결합될 때에는 _(언더스코어) 사용.
