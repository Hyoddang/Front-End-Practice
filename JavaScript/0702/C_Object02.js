...
console.log(Math.floor(Math.random() * 11)); // 0과 100사이의 숫자
...
// 만약 찾지 못할 경우 객체의 프로토타입에서 찾는다.

let academy = new Person('IT');
console.log(academy.constructor === Person);
console.log(academy.constructor.prototype === Person);
...
// 배열: 순서가 있는 데이터의 목록
// 배열의 요소는 어떤 데이터 타입이든 될 수 있으며, 하나의 배열에 다양한 데이터 타입의 데이터를 함께 저장 가능
...
//? JSON 사용
// 서로 다른 시스템 간에 구조화된 데이터를 전송하는 데 만이 사용
